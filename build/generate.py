...
PHOSPHOR_GREEN = {
    ...
    "quote": "#38b463", "faint": "#195c2e",
    "accentFill": "#2bcf70", "accent": "#2bcf70", "accentDeep": "#5cf59b",
    "accentFg": "#03130a", "brand": "#5cf59b", "brandDeep": "#54ff8c",
    "type": "#38b463", "string": "#38b463", "number": "#38b463",
    "func": "#54ff8c", "builtin": "#2bcf70", "regexp": "#38b463",
    "error": "#f87171", "errorDeep": "#f87171", "warning": "#eab308",
...
PHOSPHOR_AMBER = {
    ...
    "quote": "#cf9b56", "faint": "#704a07",
    "accentFill": "#ffb454", "accent": "#ffb454", "accentDeep": "#ffd9a0",
    "accentFg": "#160a00", "brand": "#ffd9a0", "brandDeep": "#ffcf8a",
    "type": "#cf9b56", "string": "#cf9b56", "number": "#cf9b56",
    "func": "#ffcf8a", "builtin": "#ffb454", "regexp": "#cf9b56",
    "error": "#f87171", "errorDeep": "#f87171", "warning": "#eab308",
...
def colors(P):
    ...
    return {
        ...
        "inputOption.activeForeground": p["accentDeep"],
        ...
        "textLink.activeForeground": p["accentDeep"],
